...
from authentication.views import CustomLoginView, CustomLogoutView, CustomPasswordResetView, \
    CustomPasswordResetDoneView, CustomPasswordResetConfirmView, registration, CustomPasswordResetCompleteView
